<section class="highlightVideos" itemscope itemtype="http://schema.org/VideoObject">
    ...
    ?>
                    <article class="<?php echo $article_class; ?>" itemprop="video" itemscope itemtype="http://schema.org/VideoObject">
                        <figure itemprop="thumbnailUrl">
                            <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark">
                                <?php if (has_post_thumbnail()) : ?>
                                    <?php the_post_thumbnail($thumbnail_size, ['alt' => get_the_title()]); ?>
                                <?php endif; ?>
                            </a>
                        </figure>
                        <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark">
